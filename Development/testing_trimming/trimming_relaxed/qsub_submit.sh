...
/ye/netapp/jimmie.ye/tools/STAR/bin/Linux_x86_64/STAR --genomeDir /ye/yelabstore/10x.ref/refdata-cellranger-mm10-1.2.0/star --outFilterScoreMinOverLread 0.3 --outFilterMatchNminOverLread 0.3  --outSAMstrandField intronMotif --readFilesCommand zcat --readFilesIn *.fq.gz --runThreadN 6
