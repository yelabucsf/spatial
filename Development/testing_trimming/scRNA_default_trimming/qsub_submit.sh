...
trim_galore $R2_file --trim-n -a AAAAAAAA -o $dir_name
cd "$dir_name" 

# run STAR with 6 threads. As in scRNA pipeline. 
/ye/netapp/jimmie.ye/tools/STAR/bin/Linux_x86_64/STAR --genomeDir /ye/yelabstore/10x.ref/refdata-cellranger-mm10-1.2.0/star --outSAMstrandField intronMotif --readFilesCommand zcat --readFilesIn *.fq.gz --runThreadN 6
