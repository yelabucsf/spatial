...
if __name__ == "__main__":
    ...
    barcode_num = "human_mouse_gene_count/cell_annotate.txt"
    ...
    counts = "human_mouse_gene_count/count.MM"
    ...
    for key, val in output.items():
        w.writerow([key, val[0][0][0], val[0][0][1].strip("\n"), val[0][1], val[1]])
