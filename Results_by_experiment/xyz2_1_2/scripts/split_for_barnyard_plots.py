# pretty gross code for splitting UMI read counts by barcodes and spatial direction 
# winter 2018 
...
if __name__ == "__main__": 
	...
	with open("umi_spatial_output.csv") as f: 
		for line in f: 
			line = line.strip("\n")
			gene, org, x, y, pcr, count = line.split(",")
			x = int(x)
			y = int(y)
			if org == "hg": 
				if (x,y) in count_x_y_human: 
